...
np.random.seed(1)
unpack = True #set to false after first time if experimenting on data

image_dir = os.path.abspath('../images/cifar/cifar10/by-image/')
#cwd = os.path.abspath(os.getcwd())
if not os.path.exists('../workdir'):
    os.makedirs('../workdir')
if not os.path.exists(os.path.join(image_dir, 'train+val')):
    os.makedirs(os.path.join(image_dir, 'train+val'))
...
if not os.path.exists(os.path.join(image_dir, 'test')):
    os.makedirs(os.path.join(image_dir, 'test'))
