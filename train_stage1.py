...
def main():
    ...
    if args.isMT:
        model_name = '%s_%d_mean_teacher_split_%d_isL2_%d' % (args.dataset,args.num_labeled,args.label_split,int(args.isL2))#'%s_%s_%d_mean_teacher_split_%d_isL2_%d_%s' % ('t1', args.dataset,args.num_labeled,args.label_split,int(args.isL2), date)
    else:
        model_name = '%s_%d_split_%d_isL2_%d' % (args.dataset,args.num_labeled,args.label_split,int(args.isL2))#'%s_%s_%d_split_%d_isL2_%d_%s' % ('t1', args.dataset,args.num_labeled,args.label_split,int(args.isL2), date)
